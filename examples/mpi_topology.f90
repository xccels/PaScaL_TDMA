...
!> @brief       This file contains a module of 2D/3D communication topology for the example problem of PaScaL_TDMA.
...
!> @brief       Module for creating the 2D cartesian topology of the MPI processes and subcommunicators.
...
!>
!> @brief       Module for creating the 3D cartesian topology of the MPI processes and subcommunicators.
!> @details     This module has three subcommunicators in each-direction and related subroutines.
!>
module mpi_topology_3D
    use mpi
    implicit none
